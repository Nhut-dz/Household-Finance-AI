...
chỉ số **validation** — nhưng người đọc số vẫn nên nhớ rằng tập test đã được
nhìn nhiều lần, nên nó không còn là ước lượng "hoàn toàn chưa thấy" như lần
chấm đầu. Con số đem báo cáo cuối cùng nên lấy từ một lần chạy sạch trên seed
đã chốt.
"""
...
def build_ml01_report(
    ...
    log.info("── Task 12: so sánh validation với test ──")
    comparison = compare_models(params, seed=seed, runs_dir=runs_dir)
